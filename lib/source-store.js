...
const TAVILY_BRIDGE_DOMAINS = [
  // Existing broad web-search bridges
  ...
  // OSINT resources from the Hackmasters realtime OSINT source pack
  { id: "osint-worldsteps", name: "World Steps OSINT", domain: "worldsteps.com", confidence: 0.62 },
  { id: "osint-monitorthesituation", name: "Monitor the Situation OSINT", domain: "monitorthesituation.com", confidence: 0.68 },
  { id: "osint-worldmonitor", name: "World Monitor OSINT", domain: "worldmonitor.app", confidence: 0.78 },
  { id: "osint-worldnewsapi", name: "World News API", domain: "worldnewsapi.com", confidence: 0.72 },
  { id: "osint-babelstreet", name: "Babel Street OSINT Streams", domain: "babelstreet.com", confidence: 0.72 },
  { id: "osint-recordedfuture", name: "Recorded Future", domain: "recordedfuture.com", confidence: 0.70 },
  { id: "osint-flashpoint", name: "Flashpoint", domain: "flashpoint.io", confidence: 0.70 },
  { id: "osint-shadowdragon", name: "ShadowDragon", domain: "shadowdragon.io", confidence: 0.70 },
  { id: "osint-acled", name: "ACLED", domain: "acleddata.com", confidence: 0.86 },
  { id: "osint-liveuamap", name: "Liveuamap", domain: "liveuamap.com", confidence: 0.76 },
  { id: "osint-usgs", name: "USGS Earthquake Feeds", domain: "earthquake.usgs.gov", confidence: 0.82 },
  { id: "osint-nasa-firms", name: "NASA FIRMS", domain: "firms.modaps.eosdis.nasa.gov", confidence: 0.82 },
  { id: "osint-osintindustries", name: "OSINT Industries", domain: "osint.industries", confidence: 0.66 },
  { id: "osint-telegram", name: "Telegram OSINT Channels", domain: "t.me", confidence: 0.48 },
  { id: "osint-talkwalker", name: "Talkwalker OSINT Roundup", domain: "talkwalker.com", confidence: 0.58 },
  { id: "osint-opensky", name: "OpenSky Network", domain: "opensky-network.org", confidence: 0.78 },
  { id: "osint-aisstream", name: "AISStream Maritime Tracking", domain: "aisstream.io", confidence: 0.76 },
  { id: "osint-gpsjam", name: "gpsjam.org GPS Interference", domain: "gpsjam.org", confidence: 0.76 },
  { id: "osint-awesome", name: "Awesome OSINT", domain: "github.com", confidence: 0.60 },
  { id: "osint-sintelix", name: "Sintelix OSINT Roundup", domain: "sintelix.com", confidence: 0.58 }
];
...
function buildTavilyBridgeSources(topic = "global") {
  ...
  return TAVILY_BRIDGE_DOMAINS.map((source) => ({
    ...
    discovered_by: "osint-source-pack",

...
function buildTavilyBridgeSources(topic = "global") {
  ...
  const domains = [
    { id: "tavily-reuters", name: "Reuters Web Search", domain: "reuters.com" },
    { id: "tavily-reddit", name: "Reddit Web Search", domain: "reddit.com" },
    { id: "tavily-substack", name: "Substack Web Search", domain: "substack.com" }
  ];
